<div class="container-fluid px-4 mx-auto">
    ...
    <h3 class="text-center text-muted mt-4">Liste des cursus </h3>

    <div class="row mt-2 mb-3">
        <div class="col-md-9 ">
            <form action="index.php?controller=cursus&task=recherche" method="post" class="form-inline">
                <input type="text" name="searchDate" id="searchDate" class="form-control" style="width:400px">
                <button type="submit" class="btn btn-dark mr-2" style="margin-left:5px ;"><i class="fa fa-search"></i></button>
            </form>
        </div>
        <div class="col-md-3">
